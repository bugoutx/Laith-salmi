    ...
    >
      ...
      {isHovered && (
        <motion.div
          ...
          className="bg-zinc-900 text-white px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap shadow-xl border border-zinc-700"
          dir="rtl"
        >
      ...
      {/* WhatsApp Button */}
      <motion.div
        className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
